...
trait SslCommerzTrait
{
    public function sslcommerzcreateSession(Request $request, $companyId)
    {
        ...
        $post_data[self::success_url]  = env('BASE_URL') . "api/company/$companyId/sslcommerz/success-path";
        $post_data[self::fail_url]     = env('BASE_URL') . "api/company/$companyId/sslcommerz/fail-path";
        $post_data[self::cancel_url]   = env('BASE_URL') . "api/company/$companyId/sslcommerz/cancel-path";
